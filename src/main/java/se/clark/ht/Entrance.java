...
//		trasaverAllSynonyms();
	...
	private static void trasaverAllSynonyms(){
		...
		System.out.println("traverse synonyms from node 'earth':");
				...
				.traverse(earth))
		{
			...
			System.out.println("Path from start node to current position is: " + position + ", to node: " + position.endNode().getProperty(NAME_KEY));
		}
